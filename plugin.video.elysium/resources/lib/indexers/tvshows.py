...
import base64, datetime, json, os, re, sys, urllib, urlparse
	...
	def tvshowDirectory(self, items):
		...
		for i in items:
			try:
				...
				if not tvdb == "0" or tvdb == None: sysmetalliq = "plugin://plugin.video.metalliq/tv/add_to_library_parsed/%s/direct.elysium.q" % tvdb
				elif "tt" in imdb: sysmetalliq = "plugin://plugin.video.metalliq/tv/add_to_library_parsed/%s/direct.elysium.q" % imdb
				else: sysmetalliq = "0"
