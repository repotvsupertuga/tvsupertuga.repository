...
__all__ = ['scraper', 'proxy', 'local_scraper', 'pw_scraper', 'watchseries_scraper', 'movie25_scraper', 'mihanshow_scraper',
           ...
           'couchtunerv1_scraper', 'ddlvalley_scraper', 'pelispedia_scraper', 'spacemov_scraper', 'vaiomv_scraper',
           ...
           'sezonlukdizi_scraper', 'movietube_scraper', 'putlocker_scraper', 'diziay_scraper', 'mersad_scraper', 'pubfilmto_scraper',
           'furk_scraper', 'hevcbluray_scraper', 'ninemovies_proxy', 'miradetodo_scraper', 'dizipas_scraper', 'xmovies8v2_scraper',
           'moviesplanet_scraper', 'premiumize_scraper', 'dlmac_scraper', 'watchitvideos_scraper', 'movieblast_scraper',
           ...
           'premiumizev2_scraper', 'cinemamkv_scraper', 'dayt_scraper', 'moviego_scraper', 'releasebb_scraper', 'movieocean_proxy',
           'rlsmovies_scraper', 'hdmoviefree_scraper', 'mihanmov_scraper', 'snagfilms_scraper', 'scenedown_scraper', 'scenerls_scraper',
